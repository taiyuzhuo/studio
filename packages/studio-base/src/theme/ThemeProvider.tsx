...
const icons: {
  ...
  PlugConnectedFilled: <PlugConnected20Filled />,
  PlugConnectedRegular: <PlugConnected20Regular />,
  PlugDisconnectedFilled: <PlugDisconnected20Filled />,
  PlugDisconnectedRegular: <PlugDisconnected20Regular />,
